...
public class MyPreferenceFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if( widths != null && heights != null ) {
			...
			String resolution_preference_key = CreateActivity.getResolutionPreferenceKey(cameraId);
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_donate") ) {
            	        ...
            	        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(CreateActivity.getDonateLink()));
        	        	startActivity(browserIntent);
                		return false;
                	}
                	return false;
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_about") ) {
                		...
                		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MyPreferenceFragment.this.getActivity());
                		String save_location = sharedPreferences.getString(CreateActivity.getSaveLocationPreferenceKey(), "OpenCamera");
                	...
                	if( pref.getKey().equals("preference_reset") ) {
			        	...
			        	.setPositiveButton(R.string.answer_yes, new DialogInterface.OnClickListener() {
					        ...
					        public void onClick(DialogInterface dialog, int which) {
		                		...
		                		editor.clear();
		                		editor.putBoolean(CreateActivity.getFirstTimePreferenceKey(), true);
		                		editor.apply();
					        }
			        	})
