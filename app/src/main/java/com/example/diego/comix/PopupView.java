...
public class PopupView extends LinearLayout {
	...
	public PopupView(Context context) {
    	...
    	addButtonOptionsToPopup(supported_flash_values, R.array.flash_icons, R.array.flash_values, getResources().getString(R.string.flash_mode), preview.getCurrentFlashValue(), "TEST_FLASH", new ButtonOptionsPopupListener() {
    		...
    		String current_iso = sharedPreferences.getString(CreateActivity.getISOPreferenceKey(), "auto");
        	...
        	addButtonOptionsToPopup(supported_isos, -1, -1, "ISO", current_iso, "TEST_ISO", new ButtonOptionsPopupListener() {
    			...
    			public void onClick(String option) {
    				...
    				editor.putString(CreateActivity.getISOPreferenceKey(), option);
    				editor.apply();
    		...
    		if( preview.getCameraController() != null ) {
	        	...
	        	addRadioOptionsToPopup(supported_white_balances, getResources().getString(R.string.white_balance), CreateActivity.getWhiteBalancePreferenceKey(), preview.getCameraController().getDefaultWhiteBalance(), "TEST_WHITE_BALANCE");
	
	        	List<String> supported_scene_modes = preview.getSupportedSceneModes();
	        	addRadioOptionsToPopup(supported_scene_modes, getResources().getString(R.string.scene_mode), CreateActivity.getSceneModePreferenceKey(), preview.getCameraController().getDefaultSceneMode(), "TEST_SCENE_MODE");
	
	        	List<String> supported_color_effects = preview.getSupportedColorEffects();
	        	addRadioOptionsToPopup(supported_color_effects, getResources().getString(R.string.color_effect), CreateActivity.getColorEffectPreferenceKey(), preview.getCameraController().getDefaultColorEffect(), "TEST_COLOR_EFFECT");
    		}
        	...
        	if( main_activity.supportsAutoStabilise() ) {
        		...
        		checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
					public void onCheckedChanged(CompoundButton buttonView,
	    				...
	    				SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(main_activity);
						SharedPreferences.Editor editor = sharedPreferences.edit();
						editor.putBoolean(CreateActivity.getAutoStabilisePreferenceKey(), isChecked);
						editor.apply();
    		...
    		addArrayOptionsToPopup(picture_size_strings, getResources().getString(R.string.preference_resolution), picture_size_index, new ArrayOptionsPopupListener() {
    			private void update() {
    				...
    				SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(main_activity);
					SharedPreferences.Editor editor = sharedPreferences.edit();
					editor.putString(CreateActivity.getResolutionPreferenceKey(preview.getCameraId()), resolution_string);
					editor.apply();
    		...
    		addArrayOptionsToPopup(Arrays.asList(timer_entries), getResources().getString(R.string.preference_timer), timer_index, new ArrayOptionsPopupListener() {
    			private void update() {
    				...
    				SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(main_activity);
					SharedPreferences.Editor editor = sharedPreferences.edit();
					editor.putString(CreateActivity.getTimerPreferenceKey(), new_timer_value);
					editor.apply();
    			}
				@Override
				public int onClickPrev() {
